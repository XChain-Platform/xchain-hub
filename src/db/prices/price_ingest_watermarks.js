 ...
 **********************************************************************
 *
 * XChain Hub - query methods for price_ingest_watermarks, the price ingest fence.
 *
 ...
 *
 * Split out by table, not by size: the fence is the one price table with a write
 * path of its own and a monotonicity rule to state, and reading its two statements
 * should not mean scrolling past thirty snapshot queries.
 *
 ********************************************************************/
