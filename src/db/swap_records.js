...
module.exports = {
    ...
    // Moved here from src/SwapTracker.js:51. The last two arguments repeat the
    ...
    // Moved here from src/SwapTracker.js:63.
    ...
    // Moved here from src/SwapTracker.js:69, the branch that adds no status filter.
    ...
    // Moved here from src/SwapTracker.js:69, the branch that filters on status.
    ...
    // Moved here from src/SwapTracker.js:81, the branch with no attestation id.
    ...
    // Moved here from src/SwapTracker.js:81, the branch that carries an attestation id.
