...
function registerMirrorValidationSuite() {
...
function registerMirrorIdempotenceSuite() {
...
function registerMirrorRetrySuite() {
...
function registerMirrorReceiveSuite() {
...
function registerMirrorColumnTest() {
...
function registerMirrorLifecycleSuite() {
describe('a finalized round at or above the activation height', function () {
        ...
        registerMirrorColumnTest();
    });
}

function registerMirrorConstructionSuite() {
...
describe('AttestationResponseMirror', function () {
    ...
    registerMirrorConstructionSuite();

    // ── the write path ──────────────────────────────────────────────────────

    registerMirrorLifecycleSuite();

    // ── the era gate ────────────────────────────────────────────────────────

    registerMirrorReceiveSuite();

    // ── idempotence ─────────────────────────────────────────────────────────

    registerMirrorRetrySuite();

    // ── the pending-eviction race ───────────────────────────────────────────

    registerMirrorIdempotenceSuite();

    // ── what the mirror declines to carry ───────────────────────────────────

    registerMirrorValidationSuite();
});
