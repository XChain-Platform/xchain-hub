...
function registerQuorumEdgeTests() {
...
function registerQuorumCoreTests() {
...
function registerSnapshotPruneSuite() {
...
function registerSnapshotMembershipSuite() {
...
function registerSnapshotQuorumSuite() {
describe('getQuorum()', function () {
        beforeEach(function () {
            snap = new CapabilitySnapshot(makeHub());
        });

        registerQuorumCoreTests();

        registerQuorumEdgeTests();
    });
}

function registerSnapshotAmountSuite() {
...
function registerSnapshotValidatorSuite() {
...
function registerSnapshotErrorSuite() {
...
function registerSnapshotCacheSuite() {
...
function registerSnapshotUnavailableSuite() {
...
function registerSnapshotGuardSuite() {
...
describe('CapabilitySnapshot (extra coverage)', function () {
    ...
    registerSnapshotGuardSuite();

    registerSnapshotUnavailableSuite();

    registerSnapshotCacheSuite();

    registerSnapshotErrorSuite();

    registerSnapshotValidatorSuite();

    // ── getActiveValidatorSnapshot() ─────────────────────────────────────────

    registerSnapshotAmountSuite();

    // ── getQuorum() ──────────────────────────────────────────────────────────

    registerSnapshotQuorumSuite();

    // ── isInSnapshot() ───────────────────────────────────────────────────────

    registerSnapshotMembershipSuite();

    // ── prune() ─────────────────────────────────────────────────────────────

    registerSnapshotPruneSuite();
});
