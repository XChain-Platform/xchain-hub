...
describe('XChainHub standalone network (HUB_NETWORK without P2P_VALIDATOR_ADDR)', function () {
    ...
    registerStandaloneConstructorTests();
    registerStandaloneIngestTests();
    registerStandaloneApiTests();
});

function registerStandaloneConstructorTests() {
...
function registerStandaloneIngestTests() {
    ...
    describe('ingest gates on a standalone hub', function () {
        registerStandaloneIngestShapeTests();
        registerStandaloneIngestCanonicalTest();
    });
}

function registerStandaloneIngestShapeTests() {
...
function registerStandaloneIngestCanonicalTest() {
...
function registerStandaloneApiTests() {
