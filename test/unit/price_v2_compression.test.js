 ...
 *
 **********************************************************************
 * test/unit/price_v2_compression.test.js (hub copy of the xchain-indexer canonical)
 *
...
describe('price_v2_compression: consensus constants @regression', function(){
    ...
    it('PRICE_WIRE_MAX_BYTES matches the declaration in this repo\'s OraclePublisher.js', function(){
...
describe('price_v2_compression: vendored-twin byte identity @regression', function(){
    ...
    it('this copy is byte-identical to the xchain-indexer canonical', function(){
        const twin = path.join(INDEXER_DIR, 'src', 'price_v2_compression.js');
        ...
        assert.strictEqual(local, fs.readFileSync(twin, 'utf8'),
            'price_v2_compression.js has drifted from the xchain-indexer canonical; the two would ' +
