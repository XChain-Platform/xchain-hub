...
describe('SlashDetector.getSlashProposals() (public read surface)', function () {
    ...
    registerEvidenceRedactionTests();
    registerEvidenceHashParityTests();
    registerSlashQuerySuite();
    registerSlashPageBoundSuite();
    registerPendingProposalControlTest();
});
...
function registerEvidenceRedactionTests() {
...
function registerEvidenceHashParityTests() {
...
function registerSlashQuerySuite() {
    describe('query shape', function () {
        registerSlashQueryFilterTests();
        registerSlashQueryValidationTests();
    });
}

function registerSlashQueryFilterTests() {
...
function registerSlashQueryValidationTests() {
...
function registerSlashPageBoundSuite() {
    describe('server-side page bound', function () {
        registerSlashPageClampTests();
        registerSlashPageSafetyTests();
    });
}

function registerSlashPageClampTests() {
...
function registerSlashPageSafetyTests() {
...
function registerPendingProposalControlTest() {
