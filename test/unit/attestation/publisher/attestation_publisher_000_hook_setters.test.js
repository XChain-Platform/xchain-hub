...
{
describe('AttestationPublisher: hook setters', function () { it('setBroadcastHook stores the function', function () {
...
describe('AttestationPublisher: hook setters', function () { it('setWalletSignHook stores the function', function () {
        const pub = makePublisher();
        const fn = () => {};
...
describe('AttestationPublisher: hook setters', function () { it('setEncoder stores the encoder', function () {
        const pub = makePublisher();
