...
function registerFollowerBoundEffectiveTimeTests() {
...
function registerFollowerBoundOrderingTests() {
it('ACCEPTS a canonically spelled STRING, and it produces the same bytes as the number', async function () {
    ...
    registerFollowerBoundEffectiveTimeTests();
}

function registerFollowerBoundClockTests() {
...
function registerFollowerBoundRangeTests() {
...
describe('follower bounds on a leader-chosen effective_time', function () {
    ...
    registerFollowerBoundRangeTests();

    registerFollowerBoundClockTests();

    registerFollowerBoundOrderingTests();
});
