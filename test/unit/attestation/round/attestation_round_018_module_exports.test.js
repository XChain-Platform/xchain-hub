...
describe('AttestationRound', function () { beforeEach(hookAt3853); afterEach(hookAt3913); describe('module exports', function () { it('exports ATTEST_PROPOSE constant', function () {
