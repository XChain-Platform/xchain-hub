...
// ── evictStaleRounds ────────────────────────────────────────────────────
describe('AttestationRound', function () { beforeEach(hookAt3853); afterEach(hookAt3913); describe('evictStaleRounds()', function () { it('removes rounds whose proposedAt is past the TTL', function () {
            let hub = makeHub();
...
// ── evictStaleRounds ────────────────────────────────────────────────────
describe('AttestationRound', function () { beforeEach(hookAt3853); afterEach(hookAt3913); describe('evictStaleRounds()', function () { it('keeps rounds without a numeric proposedAt', function () {
            let hub = makeHub();
            let ar  = new AttestationRound(hub, makeProviderRegistry());
