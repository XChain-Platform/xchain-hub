...
// ── evictStaleSeen ──────────────────────────────────────────────────────
describe('AttestationRound', function () { beforeEach(hookAt3853); afterEach(hookAt3913); describe('evictStaleSeen()', function () { it('removes entries older than retryAfterMs', function () {
            let hub = makeHub();
...
// ── evictStaleSeen ──────────────────────────────────────────────────────
describe('AttestationRound', function () { beforeEach(hookAt3853); afterEach(hookAt3913); describe('evictStaleSeen()', function () { it('does not remove entries still within the window', function () {
            let hub = makeHub();
            let ar  = new AttestationRound(hub, makeProviderRegistry());
