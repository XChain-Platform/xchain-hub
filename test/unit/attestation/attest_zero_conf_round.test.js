...
function registerFetchAccountingEdgeTests() {
...
function registerFetchAccountingCoreTests() {
...
function registerZeroConfBootOrderTest() {
...
function registerZeroConfStartSuite() {
...
function registerZeroConfFetchAccountingSuite() {
describe('getStats fetch accounting', function () {


        registerFetchAccountingCoreTests();

        registerFetchAccountingEdgeTests();
    });
}

function registerZeroConfPollSuite() {
...
function registerZeroConfHydrationSuite() {
...
function registerConfirmationsSuite() {
...
describe('AttestationRound zero-confirmation flip', function () {
    ...
    registerConfirmationsSuite();

    // ── the poll gate ───────────────────────────────────────────────────────

    registerZeroConfHydrationSuite();

    // ── the round-start line ────────────────────────────────────────────────

    registerZeroConfPollSuite();

    // ── fetch accounting ────────────────────────────────────────────────────

    registerZeroConfFetchAccountingSuite();

    // ── the boot ordering assertion ─────────────────────────────────────────

    registerZeroConfStartSuite();

    // ── the poll cadence default ────────────────────────────────────────────

    registerZeroConfBootOrderTest();
});
