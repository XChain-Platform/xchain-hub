...
function registerEffectiveLeaderSlotEdgeTests() {
...
function registerEffectiveLeaderSlotCoreTests() {
...
describe('attestation_escalation: effectiveLeaderSlot', function () {
    ...
    registerEffectiveLeaderSlotCoreTests();

    registerEffectiveLeaderSlotEdgeTests();
});
