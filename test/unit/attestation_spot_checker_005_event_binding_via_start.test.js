...
describe('AttestationSpotChecker', function () { afterEach(hookAt2320); describe('event binding via start()', function () { it('receives request:finalized events and processes them', async function () {
            let hub = makeHub();
