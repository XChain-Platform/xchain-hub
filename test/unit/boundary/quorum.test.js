...
describe('Boundary: Quorum Calculation', function () {
    ...
    describe('Consensus.getQuorum()', function () {
    ...
    describe('OracleConsensus.getQuorum()', function () {
    ...
    describe('CrossChainEngine.getQuorum()', function () {
    ...
    describe('ReorgHandler.getQuorum()', function () {
