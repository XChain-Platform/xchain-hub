...
// in the tree is inert, and it would have gone red the first time one was armed.
{
    ...
    function isArmedSoNeitherEraBlockTest12() {
    ...
    let registertheBatchCanonicalCarriesOneAdmission13;

    {
        ...
        function theMapIsKeyedOnEachTest18() {
        ...
        registertheBatchCanonicalCarriesOneAdmission13 = function registerSuite() {
            describe('the BATCH canonical carries one admission map per round', theBatchCanonicalCarriesOneAdmissionSuite14);
        };
    ...
    function priceV0SingleRoundCanonicalThreeSuite11() {
        ...
        registertheBatchCanonicalCarriesOneAdmission13();
    }

    describe('PRICE v0 single-round canonical: three-way twin parity', priceV0SingleRoundCanonicalThreeSuite11);
