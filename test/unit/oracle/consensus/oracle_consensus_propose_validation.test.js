...
const { VALIDATORS_3, buildSubmissions, makeCapabilitySnapshotStub } = require('../../../helpers/fixtures');
    ...
    function proposeEnvelope(prices, round = ROUND) {
        ...
        const ALT_ADDR = 'ws://leader-alt:10001';
...
function register2399ProposerExcludedFromDeviation2Hooks() {                  // canonical, leader-only, no finalized history
...
function registerOracleconsensusFollowerPriceValidationMinsubmissions1Tests8() {
...
function registerOracleconsensusFollowerPriceValidationMinsubmissions1Tests17() {
...
function register2399ProposerExcludedFromDeviation2Tests20() {
...
describe('OracleConsensus: follower price validation / minSubmissions / broadcast', function () {
    ...
    registerOracleconsensusFollowerPriceValidationMinsubmissions1Tests1();
    registerOracleconsensusFollowerPriceValidationMinsubmissions1Tests8();
    registerOracleconsensusFollowerPriceValidationMinsubmissions1Tests11();
    registerOracleconsensusFollowerPriceValidationMinsubmissions1Tests14();
    registerOracleconsensusFollowerPriceValidationMinsubmissions1Tests17();
    ...
    describe('#2399 proposer excluded from deviation reference by pubkey', function () {
        register2399ProposerExcludedFromDeviation2Hooks();
        register2399ProposerExcludedFromDeviation2Tests20();
    });
});
