...
function governanceAuthorizationSuite() {
...
function changeBoundsSuiteTests1() {
...
function changeBoundsSuiteTests2() {
...
function changeBoundsSuite() {

        changeBoundsSuiteTests1();

        changeBoundsSuiteTests2();
    }

function proposalCooldownSuite() {
...
function proposalApprovalSuite() {
...
function governancePipelineSuite() {
    ...
    describe('E2E-GOV-001: Proposal lifecycle - approve', proposalApprovalSuite);

    // E2E-GOV-002: Rejection and cooldown
    describe('E2E-GOV-002: Proposal rejection and cooldown', proposalCooldownSuite);

    // E2E-GOV-003: Change bounds enforcement
    describe('E2E-GOV-003: Change bounds enforcement', changeBoundsSuite);

    // E2E-GOV: Non-validator cannot propose
    describe('E2E-GOV: Authorization', governanceAuthorizationSuite);
}

describe('E2E: Governance Pipeline', governancePipelineSuite);
