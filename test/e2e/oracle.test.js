...
function rewardDistributionSuite() {
...
function degradedPricePipelineSuite() {
...
function normalPricePipelineSuiteTests1() {
...
function normalPricePipelineSuiteTests2() {
...
function normalPricePipelineSuite() {

        normalPricePipelineSuiteTests1();

        normalPricePipelineSuiteTests2();
    }

function oraclePipelineSuite() {
    ...
    describe('E2E-ORACLE-001: Normal price pipeline (single-node)', normalPricePipelineSuite);

    // E2E-ORACLE-003: One external API down
    describe('E2E-ORACLE-003: One API down, graceful degradation', degradedPricePipelineSuite);

    // E2E-ORACLE-004: All APIs down, round skipped
    describe('E2E-ORACLE-004: All APIs down, round skipped', skippedRoundSuite);

    // E2E-ORACLE-006: Rewards distributed after finalization
    describe('E2E-ORACLE-006: Reward distribution', rewardDistributionSuite);

    // E2E-ORACLE: Previous round data persists after new round
    describe('E2E-ORACLE: Multiple rounds', multipleRoundsSuite);
}

describe('E2E: Oracle Price Pipeline', oraclePipelineSuite);
