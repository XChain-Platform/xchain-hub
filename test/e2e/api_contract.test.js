...
function invalidInputSuiteTests1() {
...
function invalidInputSuiteTests2() {
...
function invalidInputSuiteTests3() {
...
function invalidInputSuite() {
        invalidInputSuiteTests1();

        invalidInputSuiteTests2();

        invalidInputSuiteTests3();
    }

function validResponsesSuiteTests1() {
...
function validResponsesSuiteTests2() {
...
function validResponsesSuiteTests3() {
...
function validResponsesSuiteTests4() {
...
function validResponsesSuiteTests5() {
...
function validResponsesSuite() {
        validResponsesSuiteTests1();

        validResponsesSuiteTests2();

        validResponsesSuiteTests3();

        validResponsesSuiteTests4();

        validResponsesSuiteTests5();
    }

function apiContractSuite() {
    ...
    describe('E2E-API-001: All methods return valid responses', validResponsesSuite);

    // E2E-API-002: Invalid input handling
    describe('E2E-API-002: Invalid input handling', invalidInputSuite);
}

describe('E2E: API Contract Verification', apiContractSuite);
