...
describe('Integration: JSON-RPC API (SC-8.x)', function () {
    registerApiHooks();
    describe('SC-8.3: Validator state', registerValidatorStateTests);
    registerErrorResponseTests();
});

function registerValidatorStateTests() {
    registerValidatorQueryTests();
    registerValidatorLifecycleTests();
}

function registerValidatorQueryTests() {
...
function registerValidatorLifecycleTests() {
...
function registerErrorResponseTests() {
